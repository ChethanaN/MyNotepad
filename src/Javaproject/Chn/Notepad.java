...
boolean newFileFlag;
String fileName;
String applicationTitle="MyNotepad(JAVA)";
...
{
JOptionPane.showMessageDialog(Notepad.this.f,aboutText,"My JAVA Project",JOptionPane.INFORMATION_MESSAGE);
}
else
...
final String formatForeground="Font color";
final String formatBackground="Pad color";

final String viewStatusBar="Status Bar";

final String helpHelpTopic="Help Topic";
final String helpAboutNotepad="About MyNotepad";

final String aboutText=
	"<html><big>My JAVA Notepad</big><hr><hr>"
	+"<p>This is developed by Chethana.N"
	+"<hr><p align=left>This is developed using NetBeans IDE 11.2<br><br>"
	+"<strong>My First Java Application</strong><br>"
	+"You can write to us at<p align=center>"
	+"<hr><em><big>exampleChn@gmail.com</big></em><hr><html>";
}
